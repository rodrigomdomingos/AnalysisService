...
public class AnalysisResponse {
    ...
    public AnalysisResponse(Long stockId, String ticker, OffsetDateTime date, BigDecimal rsi, BigDecimal ma50, BigDecimal ma200, BigDecimal pe, BigDecimal evEbitda, BigDecimal peg, BigDecimal fcfYield, BigDecimal revenueGrowth, BigDecimal netMargin, BigDecimal roe, BigDecimal roic, BigDecimal debtEquity, BigDecimal freeCashFlow) {
